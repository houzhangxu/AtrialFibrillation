<form id="form-add" action="{{ url("admin/user/create") }}" class="horizontal-form">
    <!--
        ...
        <div class="span6 ">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="name" name="User[name]" class="m-wrap span12" placeholder="姓名">
        ...
        <div class="span6 ">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="email" name="User[email]" class="m-wrap span12" placeholder="Email">
        ...
        <div class="span6 ">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="hidden" id="role" name="role" class="span12 select2" value="">
