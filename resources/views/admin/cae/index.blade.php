        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption"><i class="icon-edit"></i>中英文字段列表</div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            oTable = $('#data-tables').dataTable({
                "sAjaxSource": "{{ url("admin/cae/record.data") }}",       //请求地址
                "sServerMethod":"GET",
                "aLengthMenu": [
                    [10, 20, 50, 100],
                ...
                "aoColumns":[
                    ...
                    { "mData": "chinese_name","sTitle": "中文名称",  "sDefaultContent": "无", "bSortable": true},
                    { "mData": "english_name","sTitle": "英文名称",  "sDefaultContent": "无", "bSortable": true},
