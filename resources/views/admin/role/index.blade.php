    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            oTable = $('#data-tables').dataTable({
                "sAjaxSource": "{{ url("admin/role/record.data") }}",       //请求地址
                "sServerMethod":"GET",
                "aLengthMenu": [
                    [10, 20, 50, 100],
                ...
                "aoColumns":[
                    ...
                    { "mData": "name","sTitle": "角色",  "sDefaultContent": "无", "bSortable": true},
                    { "mData": "permissions","sTitle": "权限",  "sDefaultContent": "无", "bSortable": true,
